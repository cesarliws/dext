...
- **S54 Direct Codecs** — Dext.Core.TypeModel, Dext.Core.DirectAccess, Dext.Codecs.Registry, Dext.Serialization.Protobuf e a CLI de codecs agora compartilham plans de campos, habilitando leitura/escrita direta por offset, registry de codecs gerados, despacho gRPC por invoker estático, listas aninhadas com ownership explícito e exportação de .proto a partir de DTOs code-first.
