...
**S43** | [Net-Advanced (MessagePack, Permessage-Deflate & Native TLS)](S43-Net-Advanced.md) | 🔄 In Progress | Advanced networking optimizations: Native TLS, http.sys HTTPS, OpenSSL 3.x, dev-certs CLI, and TRestClient SSL.
