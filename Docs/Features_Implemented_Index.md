...
- **S54 Direct Codecs** — Dext.Core.TypeModel, Dext.Core.DirectAccess, Dext.Codecs.Registry, Dext.Serialization.Protobuf, and the codecs CLI now share field plans, enabling direct offset reads/writes, generated codec registration, static gRPC dispatch by invoker, nested lists with explicit ownership, and .proto export from code-first DTOs.
